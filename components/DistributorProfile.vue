    ...
    <div class="text-black">
        ...
        <div>
            <div>
                ...
                <Table :columns="colMedicine" :td="tableDataMedicine" :buttonTitle="'View Detail'" :sellMedicine="viewManufatcurerDetails"  />
            </div>
        </div>
        <div>
            <div>
...
const getDistributorDetails = async ()=>{
    ...
    userDetails.value.verified = supplierDetails.verified
    userDetails.value.name = supplierDetails.name
    userDetails.value.id = supplierDetails.id

}

const getSupplierSoldMedicineList = async()=>{
...
const verifyOrder = async (orderData)=>{
    const txObject = {
      ...
      data: contractScm.methods.ordererVerification(
        orderData.orderId
...
const viewManufatcurerDetails = async (id)=>{
    console.log(id)
}
